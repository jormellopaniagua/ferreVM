...
public class ActualizarCliente extends javax.swing.JFrame {
     ...
     */
    public ActualizarCliente(Cliente client) {
        initComponents();
        this.setCampos(client);
        this.getClienteId().setEditable(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_tipoId, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_telCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_direccionCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(42, 42, 42)
                        .addComponent(clienteId, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btn_registrarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarClienteActionPerformed
            ...
            &&  this.getDireccion().getText()!="" && getTelefono().getText() != "")
        {
            ...
            cliente.setId(Integer.valueOf(this.getClienteId().getText()));
            ...
            cliente.setTelefono(this.getTelefono().getText());
                ...
                try{
                        clientesctrl.getById(cliente.getId());
                        clientesctrl.actualizar(cliente);
    ...
    public void setCampos(Cliente client){
        this.getTipoid().setText(String.valueOf(client.getTipoId()));
        this.getNombre().setText(client.getNombreCliente());
        this.getDireccion().setText(String.valueOf(client.getDireccion()));
        this.getTelefono().setText(client.getTelefono());
        this.getClienteId().setText(String.valueOf(client.getId()));
